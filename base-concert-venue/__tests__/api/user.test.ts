...
test("POST /api/users receive token with correct credentials", async () => {
...
test("GET /api/user/[userId]/reservations return number of reservations" , async () => {
  await testApiHandler({
...
test("GET /api/user/[userId]/reservations return empty array of users without reservations" , async () => {
  await testApiHandler({
    handler: userReservationHandler,
...
test("GET /api/user/[userId]/reservations return 401 status when unauthorized", async () => {
